#!/bin/bash
# Base parameters
FIRST_MODEL="hstasnet"
SECOND_MODEL="htdemucs"
FIRST_CONFIG="configs/config_musdb18_hstasnet_lg.yaml"
SECOND_CONFIG="./pretrained/config_musdb18_htdemucs.yaml"
FIRST_CHECKPOINT="./results/model_hstasnet_ep_0_sdr_4.4599.ckpt"
SECOND_CHECKPOINT="./pretrained/htdemucs4.ckpt"
BASE_OUTPUT_DIR="./results/merged_models"
TEST_SONG="aljames"
TEST_DATA_DIR="/Users/liampower/stepincto/Music-Source-Separation-Training/aljames/"
CONFIG_PATH="configs/config_musdb18_hstasnet_lg.yaml"
...
run_inference_and_evaluate() {
    ...
    PYTORCH_ENABLE_MPS_FALLBACK=1 python batch_ola.py \
